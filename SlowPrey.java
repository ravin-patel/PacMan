...
public class SlowPrey extends Creature {
	...
	public void draw(Graphics2D g2) {
		...
		g2.setColor(Color.decode( "#088A08" ));
		g2.fillArc (xPosition, yPosition+31, radius/2, radius/2, 0, 180);
		g2.setColor(Color.decode( "#088A08" ));
		g2.fillArc (xPosition+20, yPosition+31, radius/2, radius/2, 0, 180);

		// ghost eyes
		g2.setColor(Color.WHITE);
		g2.fillOval(xPosition + radius / 4 ,yPosition + radius / 4 , radius / 5, radius / 5); // drawing eye;
		g2.setColor(Color.BLACK);
		g2.fillOval((xPosition+7) + radius / 8 ,(yPosition+6) + radius / 8 , radius / 10, radius / 10);
		g2.setColor(Color.WHITE);
		g2.fillOval(xPosition + radius / 4 + (radius / 4) ,yPosition + radius / 4 , radius / 5, radius / 5); // drawing eye;
		g2.setColor(Color.BLACK);
		g2.fillOval((xPosition+16) + radius / 8 ,(yPosition+6) + radius / 8 , radius / 10, radius / 10);
	}
}
